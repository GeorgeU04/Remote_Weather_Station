 ...
 *
 * @Note : the use of this function is dangerous and must be done with
 * precaution, the risks are: 1 - an update of this data structure may affect
 * the operation of timer server 2 - data structure is moving according the
 * events, so read must be under critical section
 */
