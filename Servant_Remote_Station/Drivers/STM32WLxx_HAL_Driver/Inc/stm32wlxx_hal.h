...
#define SYSCFG_FLAG_SRAM_BUSY                                                  \
  SYSCFG_SCSR_SRAMBSY /*!< SRAM1 or SRAM2 erase operation is ongoing */
#define SYSCFG_FLAG_PKASRAM_BUSY                                               \
  SYSCFG_SCSR_PKASRAMBSY /*!< PKA SRAM busy by erase operation */
/**
 * @}
 */
...
#define HAL_SYSCFG_GRP1_RESERVED                                               \
  0x00U /*!< Define user to differentiate Group1 to Group 2                */

#if defined(CORE_CM0PLUS)
/** @brief  Interrupt mask related to CPU2 NVIC
 */
#define HAL_SYSCFG_GRP1_RTCSTAMP_RTCTAMP_LSECSS                                \
  (LL_C2_SYSCFG_GRP1_RTCSTAMP_RTCTAMP_LSECSS |                                 \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from RTC TimeStamp,    \
                                RTC Tampers and LSE Clock Security System to   \
                                CPU2               */
#define HAL_SYSCFG_GRP1_RTCALARM                                               \
  (LL_C2_SYSCFG_GRP1_RTCALARM |                                                \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from RTC Alarms to     \
                                CPU2                 */
#define HAL_SYSCFG_GRP1_RTCSSRU                                                \
  (LL_C2_SYSCFG_GRP1_RTCSSRU |                                                 \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from RTC SSRU to CPU2  \
                              */
#define HAL_SYSCFG_GRP1_RTCWKUP                                                \
  (LL_C2_SYSCFG_GRP1_RTCWKUP |                                                 \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from RTC Wakeup to     \
                                CPU2                 */
#define HAL_SYSCFG_GRP1_RCC                                                    \
  (LL_C2_SYSCFG_GRP1_RCC |                                                     \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from RCC to CPU2 */
#define HAL_SYSCFG_GRP1_FLASH                                                  \
  (LL_C2_SYSCFG_GRP1_FLASH |                                                   \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from FLASH to CPU2 */
#define HAL_SYSCFG_GRP1_PKA                                                    \
  (LL_C2_SYSCFG_GRP1_PKA |                                                     \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from PKA to CPU2 */
#define HAL_SYSCFG_GRP1_AES                                                    \
  (LL_C2_SYSCFG_GRP1_AES |                                                     \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from AES to CPU2 */
#define HAL_SYSCFG_GRP1_COMP                                                   \
  (LL_C2_SYSCFG_GRP1_COMP |                                                    \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from Comparator to     \
                                CPU2                 */
#define HAL_SYSCFG_GRP1_ADC                                                    \
  (LL_C2_SYSCFG_GRP1_ADC |                                                     \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from Analog Digital    \
                                Converter to CPU2   */
#define HAL_SYSCFG_GRP1_DAC                                                    \
  (LL_C2_SYSCFG_GRP1_DAC |                                                     \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from Digital Analog    \
                                Converter to CPU2   */

#define HAL_SYSCFG_GRP1_EXTI0                                                  \
  (LL_C2_SYSCFG_GRP1_EXTI0 |                                                   \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 0 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI1                                                  \
  (LL_C2_SYSCFG_GRP1_EXTI1 |                                                   \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 1 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI2                                                  \
  (LL_C2_SYSCFG_GRP1_EXTI2 |                                                   \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 2 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI3                                                  \
  (LL_C2_SYSCFG_GRP1_EXTI3 |                                                   \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 3 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI4                                                  \
  (LL_C2_SYSCFG_GRP1_EXTI4 |                                                   \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 4 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI5                                                  \
  (LL_C2_SYSCFG_GRP1_EXTI5 |                                                   \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 5 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI6                                                  \
  (LL_C2_SYSCFG_GRP1_EXTI6 |                                                   \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 6 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI7                                                  \
  (LL_C2_SYSCFG_GRP1_EXTI7 |                                                   \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 7 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI8                                                  \
  (LL_C2_SYSCFG_GRP1_EXTI8 |                                                   \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 8 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI9                                                  \
  (LL_C2_SYSCFG_GRP1_EXTI9 |                                                   \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 9 to CPU2  */
#define HAL_SYSCFG_GRP1_EXTI10                                                 \
  (LL_C2_SYSCFG_GRP1_EXTI10 |                                                  \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 10 to CPU2 */
#define HAL_SYSCFG_GRP1_EXTI11                                                 \
  (LL_C2_SYSCFG_GRP1_EXTI11 |                                                  \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 11 to CPU2 */
#define HAL_SYSCFG_GRP1_EXTI12                                                 \
  (LL_C2_SYSCFG_GRP1_EXTI12 |                                                  \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 12 to CPU2 */
#define HAL_SYSCFG_GRP1_EXTI13                                                 \
  (LL_C2_SYSCFG_GRP1_EXTI13 |                                                  \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 13 to CPU2 */
#define HAL_SYSCFG_GRP1_EXTI14                                                 \
  (LL_C2_SYSCFG_GRP1_EXTI14 |                                                  \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 14 to CPU2 */
#define HAL_SYSCFG_GRP1_EXTI15                                                 \
  (LL_C2_SYSCFG_GRP1_EXTI15 |                                                  \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 15 to CPU2 */

#else

/** @brief  Interrupt mask related to CPU1 NVIC
 */
#define HAL_SYSCFG_GRP1_RTCSTAMPTAMPLSECSS                                     \
  (LL_SYSCFG_GRP1_RTCSTAMPTAMPLSECSS |                                         \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from                   \
                                RTCSTAMPTAMPLSECSS to CPU1         */
#define HAL_SYSCFG_GRP1_RTCSSRU                                                \
  (LL_SYSCFG_GRP1_RTCSSRU |                                                    \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from RTC SSRU to CPU1  \
                              */
#define HAL_SYSCFG_GRP1_EXTI5                                                  \
  (LL_SYSCFG_GRP1_EXTI5 |                                                      \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 5 to CPU1  */
#define HAL_SYSCFG_GRP1_EXTI6                                                  \
  (LL_SYSCFG_GRP1_EXTI6 |                                                      \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 6 to CPU1  */
#define HAL_SYSCFG_GRP1_EXTI7                                                  \
  (LL_SYSCFG_GRP1_EXTI7 |                                                      \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 7 to CPU1  */
#define HAL_SYSCFG_GRP1_EXTI8                                                  \
  (LL_SYSCFG_GRP1_EXTI8 |                                                      \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 8 to CPU1  */
#define HAL_SYSCFG_GRP1_EXTI9                                                  \
  (LL_SYSCFG_GRP1_EXTI9 |                                                      \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 9 to CPU1  */
#define HAL_SYSCFG_GRP1_EXTI10                                                 \
  (LL_SYSCFG_GRP1_EXTI10 |                                                     \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 10 to CPU1 */
#define HAL_SYSCFG_GRP1_EXTI11                                                 \
  (LL_SYSCFG_GRP1_EXTI11 |                                                     \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 11 to CPU1 */
#define HAL_SYSCFG_GRP1_EXTI12                                                 \
  (LL_SYSCFG_GRP1_EXTI12 |                                                     \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 12 to CPU1 */
#define HAL_SYSCFG_GRP1_EXTI13                                                 \
  (LL_SYSCFG_GRP1_EXTI13 |                                                     \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 13 to CPU1 */
#define HAL_SYSCFG_GRP1_EXTI14                                                 \
  (LL_SYSCFG_GRP1_EXTI14 |                                                     \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 14 to CPU1 */
#define HAL_SYSCFG_GRP1_EXTI15                                                 \
  (LL_SYSCFG_GRP1_EXTI15 |                                                     \
   HAL_SYSCFG_GRP1_RESERVED) /*!< Enabling of interrupt from External          \
                                Interrupt Line 15 to CPU1 */
...
#define HAL_SYSCFG_GRP2_RESERVED                                               \
  0x80U /*!< Define user to differentiate Group1 to Group 2                */

#if defined(CORE_CM0PLUS)
/** @brief  Interrupt mask related to CPU2 NVIC
 */
#define HAL_SYSCFG_GRP2_DMA1CH1                                                \
  (LL_C2_SYSCFG_GRP2_DMA1CH1 |                                                 \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA1 Channel 1 to \
                                CPU2             */
#define HAL_SYSCFG_GRP2_DMA1CH2                                                \
  (LL_C2_SYSCFG_GRP2_DMA1CH2 |                                                 \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA1 Channel 2 to \
                                CPU2             */
#define HAL_SYSCFG_GRP2_DMA1CH3                                                \
  (LL_C2_SYSCFG_GRP2_DMA1CH3 |                                                 \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA1 Channel 3 to \
                                CPU2             */
#define HAL_SYSCFG_GRP2_DMA1CH4                                                \
  (LL_C2_SYSCFG_GRP2_DMA1CH4 |                                                 \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA1 Channel 4 to \
                                CPU2             */
#define HAL_SYSCFG_GRP2_DMA1CH5                                                \
  (LL_C2_SYSCFG_GRP2_DMA1CH5 |                                                 \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA1 Channel 5 to \
                                CPU2             */
#define HAL_SYSCFG_GRP2_DMA1CH6                                                \
  (LL_C2_SYSCFG_GRP2_DMA1CH6 |                                                 \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA1 Channel 6 to \
                                CPU2             */
#define HAL_SYSCFG_GRP2_DMA1CH7                                                \
  (LL_C2_SYSCFG_GRP2_DMA1CH7 |                                                 \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA1 Channel 7 to \
                                CPU2             */

#define HAL_SYSCFG_GRP2_DMA2CH1                                                \
  (LL_C2_SYSCFG_GRP2_DMA2CH1 |                                                 \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA2 Channel 1 to \
                                CPU2             */
#define HAL_SYSCFG_GRP2_DMA2CH2                                                \
  (LL_C2_SYSCFG_GRP2_DMA2CH2 |                                                 \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA2 Channel 2 to \
                                CPU2             */
#define HAL_SYSCFG_GRP2_DMA2CH3                                                \
  (LL_C2_SYSCFG_GRP2_DMA2CH3 |                                                 \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA2 Channel 3 to \
                                CPU2             */
#define HAL_SYSCFG_GRP2_DMA2CH4                                                \
  (LL_C2_SYSCFG_GRP2_DMA2CH4 |                                                 \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA2 Channel 4 to \
                                CPU2             */
#define HAL_SYSCFG_GRP2_DMA2CH5                                                \
  (LL_C2_SYSCFG_GRP2_DMA2CH5 |                                                 \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA2 Channel 5 to \
                                CPU2             */
#define HAL_SYSCFG_GRP2_DMA2CH6                                                \
  (LL_C2_SYSCFG_GRP2_DMA2CH6 |                                                 \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA2 Channel 6 to \
                                CPU2             */
#define HAL_SYSCFG_GRP2_DMA2CH7                                                \
  (LL_C2_SYSCFG_GRP2_DMA2CH7 |                                                 \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMA2 Channel 7 to \
                                CPU2             */

#define HAL_SYSCFG_GRP2_DMAMUX1                                                \
  (LL_C2_SYSCFG_GRP2_DMAMUX1 |                                                 \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from DMAMUX1 to CPU2   \
                              */

#define HAL_SYSCFG_GRP2_PVM3                                                   \
  (LL_C2_SYSCFG_GRP2_PVM3 |                                                    \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from Power Voltage     \
                                Monitoring 3 to CPU2 */
#define HAL_SYSCFG_GRP2_PVD                                                    \
  (LL_C2_SYSCFG_GRP2_PVD |                                                     \
   HAL_SYSCFG_GRP2_RESERVED) /*!< Enabling of interrupt from Power Voltage     \
                                Detector to CPU2     */
...
#define __HAL_DBGMCU_FREEZE_I2C2_TIMEOUT()                                     \
  LL_DBGMCU_APB1_GRP1_FreezePeriph(LL_DBGMCU_APB1_GRP1_I2C2_STOP)
#define __HAL_DBGMCU_UNFREEZE_I2C2_TIMEOUT()                                   \
  LL_DBGMCU_APB1_GRP1_UnFreezePeriph(LL_DBGMCU_APB1_GRP1_I2C2_STOP)
#endif
...
#define __HAL_DBGMCU_FREEZE_LPTIM3()                                           \
  LL_DBGMCU_APB1_GRP2_FreezePeriph(LL_DBGMCU_APB1_GRP2_LPTIM3_STOP)
#define __HAL_DBGMCU_UNFREEZE_LPTIM3()                                         \
  LL_DBGMCU_APB1_GRP2_UnFreezePeriph(LL_DBGMCU_APB1_GRP2_LPTIM3_STOP)
#endif
...
#define __HAL_C2_DBGMCU_FREEZE_I2C2_TIMEOUT()                                  \
  LL_C2_DBGMCU_APB1_GRP1_FreezePeriph(LL_C2_DBGMCU_APB1_GRP1_I2C2_STOP)
#define __HAL_C2_DBGMCU_UNFREEZE_I2C2_TIMEOUT()                                \
  LL_C2_DBGMCU_APB1_GRP1_UnFreezePeriph(LL_C2_DBGMCU_APB1_GRP1_I2C2_STOP)
#endif
...
#define __HAL_C2_DBGMCU_FREEZE_LPTIM3()                                        \
  LL_C2_DBGMCU_APB1_GRP2_FreezePeriph(LL_C2_DBGMCU_APB1_GRP2_LPTIM3_STOP)
#define __HAL_C2_DBGMCU_UNFREEZE_LPTIM3()                                      \
  LL_C2_DBGMCU_APB1_GRP2_UnFreezePeriph(LL_C2_DBGMCU_APB1_GRP2_LPTIM3_STOP)
#endif
...
/** @brief  SRAM2 erase
 * @note   __SYSCFG_GET_FLAG(SYSCFG_FLAG_SRAM_BUSY) may be used to check end of
 * erase
 */
 ...
 *         Enable and lock the PVD connection to Timer1/16/17 Break input, as
 * well as the PVDE and PLS[2:0] in the PWR_CR2 register.
 * @note   The selected configuration is locked and can be unlocked only by
 * system reset.
 */
#define __HAL_SYSCFG_BREAK_PVD_LOCK()                                          \
  LL_SYSCFG_SetTIMBreakInputs(LL_SYSCFG_TIMBREAK_PVD)
...
#define __HAL_SYSCFG_GET_FLAG(__FLAG__)                                        \
  ((((((__FLAG__) == SYSCFG_FLAG_SRAM2_PE) ? SYSCFG->CFGR2 : SYSCFG->SCSR) &   \
     (__FLAG__)) != 0)                                                         \
       ? 1                                                                     \
       : 0)
...
#define IS_SYSCFG_SRAM2WRP_PAGE(__PAGE__)                                      \
  (((__PAGE__) > 0U) && ((__PAGE__) <= 0xFFFFFFFFU))
...
#if defined(DUAL_CORE)
#if defined(CORE_CM0PLUS)
#define IS_SYSCFG_IM_GRP1(__VALUE__)                                           \
  ((((__VALUE__) & 0x80U) == HAL_SYSCFG_GRP1_RESERVED) &&                      \
   ((((__VALUE__) & HAL_SYSCFG_GRP1_RTCSTAMP_RTCTAMP_LSECSS) ==                \
     HAL_SYSCFG_GRP1_RTCSTAMP_RTCTAMP_LSECSS) ||                               \
...
#define IS_SYSCFG_IM_GRP2(__VALUE__)                                           \
  ((((__VALUE__) & 0x80U) == HAL_SYSCFG_GRP2_RESERVED) &&                      \
...
#define IS_SYSCFG_IM_GRP1(__VALUE__)                                           \
  ((((__VALUE__) & 0x80U) == HAL_SYSCFG_GRP1_RESERVED) &&                      \
   ((((__VALUE__) & HAL_SYSCFG_GRP1_RTCSTAMPTAMPLSECSS) ==                     \
     HAL_SYSCFG_GRP1_RTCSTAMPTAMPLSECSS) ||                                    \
    (((__VALUE__) & HAL_SYSCFG_GRP1_RTCSSRU) == HAL_SYSCFG_GRP1_RTCSSRU) ||    \
    (((__VALUE__) & HAL_SYSCFG_GRP1_EXTI5) == HAL_SYSCFG_GRP1_EXTI5) ||        \
    (((__VALUE__) & HAL_SYSCFG_GRP1_EXTI6) == HAL_SYSCFG_GRP1_EXTI6) ||        \
    (((__VALUE__) & HAL_SYSCFG_GRP1_EXTI7) == HAL_SYSCFG_GRP1_EXTI7) ||        \
...
HAL_StatusTypeDef
HAL_RADIO_SetSwitchConfig(HAL_RADIO_SwitchConfig_TypeDef Config);
uint8_t HAL_RADIO_IsTCXO(void);
uint8_t HAL_RADIO_IsDCDC(void);
int32_t
HAL_RADIO_GetRFOMaxPowerConfig(HAL_RADIO_RFOMaxPowerConfig_TypeDef Config);
